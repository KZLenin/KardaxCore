...
import { Loader2, Plus, Building2, FileText, Check, Mail, Phone, MapPin, Briefcase, CreditCard, Tag } from "lucide-react";
...
// 🔥 ZOD ACTUALIZADO PARA EL SRI
const formSchema = z.object({
  nombre_empresa: z.string().min(3, "Mínimo 3 letras"),
  tipo_identificacion: z.string().default("RUC"),
  identificacion: z.string().min(5, "Identificación requerida"), // Era RUC
  razon_social: z.string().optional(),
  email_facturacion: z.string().email("Correo inválido").optional().or(z.literal('')),
...
const CreateEmpresaSheet = ({ onCreated }) => {
  ...
  const onSubmit = async (values) => {
    ...
    try {
      ...
      toast({ title: "¡Cliente Registrado!", description: "Ficha comercial creada correctamente." });
      form.reset();
      setIsOpen(false);
  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <Button onClick={() => setIsOpen(true)} className="bg-zinc-900 hover:bg-zinc-800 text-white shadow-md">
        <Plus className="w-4 h-4 mr-2" /> Nuevo Cliente / Empresa
      </Button>
      ...
      <SheetContent className="w-full sm:max-w-xl overflow-y-auto bg-slate-50 border-l border-zinc-200 p-0">
        <div className="bg-white p-6 border-b border-zinc-200 sticky top-0 z-10 shadow-sm">
          <SheetTitle className="text-2xl font-bold flex items-center gap-2">
            <Building2 className="w-5 h-5 text-blue-600" /> Ficha de Cliente
          </SheetTitle>
          <SheetDescription>Información oficial para ventas y facturación SRI.</SheetDescription>
        </div>
            ...
            <div className="space-y-4">
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <div className="relative">
                      ...
                      <Input placeholder="Ej. SmartFit Condado" className="pl-9 h-10 bg-white" {...field} />
                    </div>
                  </FormControl>
                  <FormMessage />
                </FormItem>
                  ...
                  <FormItem className="col-span-2">
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input placeholder="1790000000001" className="pl-9 h-10 bg-white font-mono" {...field} />
                      </div>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
              ...
              <FormField control={form.control} name="razon_social" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Ej. Gimnasios Inteligentes S.A." className="h-10 bg-white" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )} />
            ...
            <div className="space-y-4 pt-4 border-t border-zinc-200">
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input placeholder="facturas@empresa.com" className="pl-9 h-10 bg-white" {...field} />
                      </div>
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input placeholder="02 2000 000" className="pl-9 h-10 bg-white" {...field} />
                      </div>
                    </FormControl>
                  </FormItem>
                )} />
              ...
              <FormField control={form.control} name="direccion_principal" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Av. Principal y Secundaria, Edificio..." className="h-10 bg-white" {...field} />
                  </FormControl>
                </FormItem>
              )} />
            </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                    ...
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      <FormControl>
                        <div className="relative">
                          ...
                          <SelectTrigger className="pl-9 h-10 bg-white"><SelectValue /></SelectTrigger>
                        </div>
                      </FormControl>
                      <SelectContent>
                ...
                <FormField control={form.control} name="nombre_contacto" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Ej. Juan Pérez (Compras)" className="h-10 bg-white" {...field} />
                    </FormControl>
                  </FormItem>
                )} />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 p-4 bg-zinc-100/50 border border-zinc-200 rounded-lg">
                <FormField control={form.control} name="dias_credito" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="number" min="0" className="h-10 bg-white" {...field} />
                    </FormControl>
                    <FormDescription className="text-xs">0 si es de contado.</FormDescription>
                  </FormItem>
                )} />
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <div className="relative">
                        ...
                        <Input type="number" step="0.01" min="0" className="pl-9 h-10 bg-white font-mono" {...field} />
                      </div>
                    </FormControl>
                  </FormItem>
                )} />
